...
import cv2
import socket
from zeus_nav_pid_speed_backup import move_to_points
import time
import numpy as np
...
if __name__ == "__main__":
    ...
    # Load path
    # ------------------------------------------------------------
    points = load_csv("/Users/divija/Divi Drive/workplace/Princeton/Sem 5/Carlab/carlab_2025/ece_straight.csv")
    print("here")
    # ------------------------------------------------------------
    # Setup ESP32 socket
    # ------------------------------------------------------------
