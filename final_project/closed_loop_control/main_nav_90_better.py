...
import cv2
import socket
from zeus_nav_pid_speed_fast_only_straight_discrete_better import move_to_points
import time
import numpy as np
...
if __name__ == "__main__":
    ...
    # Load path
    # ------------------------------------------------------------
    points = load_csv("/Users/divija/Divi Drive/workplace/Princeton/Sem 5/Carlab/carlab_2025/square"
    ".csv")
    print("here")
    # ------------------------------------------------------------
    # Setup ESP32 socket
    ...
    try:
        #print("here")
        move_to_points(points, s, video, K, dist)  
